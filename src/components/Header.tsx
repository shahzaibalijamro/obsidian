...
export default function Header() {
    ...
    return (
        <nav className="fixed top-0 w-full z-50">
            ...
            <div className="absolute inset-0 bg-surface/40 backdrop-blur-2xl border-b border-line-subtle pointer-events-none z-0"></div>
            ...
            <div className={`fixed inset-0 w-full h-dvh bg-mesh overflow-hidden z-40 lg:hidden flex flex-col items-center justify-center transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${isMenuOpen ? "translate-x-0" : "translate-x-full"}`}>
                ...
                <div className="relative z-10 flex flex-col items-center space-y-4 w-full px-8">
                    ...
                    <a
                        className="mt-4 px-8 py-4 bg-inverse-primary text-on-accent font-label-md rounded-full hover:bg-accent-soft hover:text-on-accent-soft transition-all duration-300 md:hidden w-full text-center"
                        href="#contact"
                        onClick={closeMenu}
                    >
                        Request a Quote
